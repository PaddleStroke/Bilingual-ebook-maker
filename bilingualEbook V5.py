...
#Setup your 2 ebook names there. Must be FB2 files.
...
STRLUES.write("winer is book A : "+ strParoleTypeA+"\n" + "winer is book B : "+ strParoleTypeB+"\n")
STRLUES.close()
...
inaRow=0
while i<len(DataA):
	print("Matching line number "+str(i)+"\n")
	matchpoint = []
	j=0
	jend=len(DataB)	
	...
	if NumSectioni[0]<0:
		...
		#match normal paragraph : test in same section and surrounding lines
